...
public class MinotaurAI : MonoBehaviour
{
    ...
    private MinotaurAttack minotaurAttack; // Reference to MinotaurAttack
    ...
    private void Start()
    {
        ...
        minotaurAttack = GetComponent<MinotaurAttack>();
    }
    ...
    private void Update()
    {
        ...
        if (distanceToPlayer <= detectionRange)
        {
            ...
            {
                StopMoving();
                minotaurAttack.StartAttack(); // Trigger attack when in range
            }
        }
        else
        {
